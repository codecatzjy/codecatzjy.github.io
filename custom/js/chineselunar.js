...
(function() {
	/*
	 ũ��ÿһ�꣬��Ӧ����������
	 ��������Դ�ڻ�������ԭ���߲���ϸ���ڴ˸�л
	 MAPPING[0][0]��ÿ�����µ��·ݣ�0��ʾ����
	 MAPPING[0][1, 13]����ʾÿ�³�һ��Ӧ������ʱ�䣬ǰ�����ַ���ʾ�£��������ַ���ʾ��
	 */
	var MAPPING = [
	...
	/*
	 * ����ĳ��ĳ��һ���ж�����
	 * daysOfMonth({}) ���� daysOfMonth(year, month, leap);
	 */
	...
	/*
	 ũ��ת����
	 lunarToSolar({})������lunarToSolar(year, month, day, leap)
	 */
	_chineseLunar.lunarToSolar = function(year, month, day, leap) {
		...
		//ȡ����Ӧ��ĳ���µ�Ƭ��
		var segment = MAPPING[offset][month]; 		//ũ����һ���Ӧ�����ľ�����
	...
	_chineseLunar.animalName = function(year) {
		return "��ţ������������Ｆ����".split("")[(year - 4) % 12];
	};

	//��ȡũ���µ�����
	_chineseLunar.monthName = function(month, traditional, leap) {
		var monthName = "��,��,��,��,��,��,��,��,��,ʮ,ʮһ,ʮ��".split(",");
		if (traditional) { monthName[11] = "��" }
		return (leap ? "��" : "") + monthName[month - 1] + "��";
	};
	...
	_chineseLunar.dayName = function(lunar) {
		switch (lunar) {
			...
			case 20: return '��ʮ';
			case 30: return '��ʮ';
			default: return ("��ʮإئ".split("")[Math.floor(lunar / 10)] +
				"һ�����������߰˾�ʮ".split("")[(lunar - 1) % 10]) || lunar;
		}
	};
